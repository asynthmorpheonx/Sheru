SRC= builtins/builtins.c builtins/ft_cd_handler.c builtins/ft_echo.c builtins/ft_export.c exec_util.c\
	execution.c utils2.c builtins/utils.c ifs_split.c mask_creation.c redirections_handle.c\
	minishell.c store_data_process.c handle_cmd_flage.c prompt_gen.c tokenize_utils.c quote_utils.c\
	...
	init_shlvl.c sig_hand.c pipe_utils.c reader_helper.c tokens_seter.c child_exec.c builtins/export_utils.c\
	cmd_path_check.c env_handle.c expansion/extend_fns.c expansion/expansion_handle.c expansion/expand_utils.c
